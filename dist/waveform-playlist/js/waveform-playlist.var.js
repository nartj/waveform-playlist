...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inlineWorker = __webpack_require__(391);
	
	var _inlineWorker2 = _interopRequireDefault(_inlineWorker);
	
	var _fileSaver = __webpack_require__(392);
	
	var _fileSaver2 = _interopRequireDefault(_fileSaver);
	
	var _conversions = __webpack_require__(393);
	
	var _LoaderFactory = __webpack_require__(394);
	
	var _LoaderFactory2 = _interopRequireDefault(_LoaderFactory);
	
	var _ScrollHook = __webpack_require__(398);
	
	var _ScrollHook2 = _interopRequireDefault(_ScrollHook);
	
	var _TimeScale = __webpack_require__(399);
	
	var _TimeScale2 = _interopRequireDefault(_TimeScale);
	
	var _Track = __webpack_require__(401);
	...
	var _AnnotationList = __webpack_require__(420);
	
	var _AnnotationList2 = _interopRequireDefault(_AnnotationList);
	
	var _recorderWorker = __webpack_require__(426);
	
	var _recorderWorker2 = _interopRequireDefault(_recorderWorker);
	
	var _exportWavWorker = __webpack_require__(427);
	
	var _exportWavWorker2 = _interopRequireDefault(_exportWavWorker);
	
	var _Undoer = __webpack_require__(428);
	
	var _Undoer2 = _interopRequireDefault(_Undoer);
	...
	var _class = function () {
	  function _class() {
	    ...
	    this.undoer = new _Undoer2.default();
	  }
	  ...
	  _createClass(_class, [{
	    ...
	    value: function setUpEventEmitter() {
	          ...
	          return regeneratorRuntime.wrap(function _callee$(_context) {
	            while (1) {
	              switch (_context.prev = _context.next) {
	                case 0:
	                  console.log('save');
	                  blob = new Blob([JSON.stringify(_this2.tracks, null)], { type: "text/plain;charset=utf-8" });
	
	                  _fileSaver2.default.saveAs(blob, "playlist.json");
	                  // todo
	      ...
	      ee.on('trim', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
	    ...
	    value: function virtualLoad(trackList) {
	      ...
	      var loadPromises = trackList.map(function (trackInfo) {
	        var loader = _LoaderFactory2.default.createLoader(trackInfo.src, _this4.ac, _this4.ee);
	        return loader.load();
	      });
	      ...
	      return Promise.all(loadPromises).then(function (audioBuffers) {
	        ...
	        var tracks = audioBuffers.map(function (audioBuffer, index) {
	          ...
	          var soloed = info.soloed || false;
	          var selection = info.selected;
	          var peaks = info.peaks || { type: 'WebAudio', mono: _this4.mono };
	          var customClass = info.customClass || undefined;
	          var waveOutlineColor = info.waveOutlineColor || undefined;
	          var stereoPan = info.stereoPan || 0;
	          var duplicationNumber = info.duplicationNumber || 0;
	          ...
	          // webaudio specific playout for now.
	          var playout = new _Playout2.default(_this4.ac, audioBuffer);
	    ...
	    value: function startOfflineRender(type) {
	      ...
	      */
	      this.offlineAudioContext.startRendering().then(function (audioBuffer) {
	        ...
	        if (type === 'wav') {
	          _this5.exportWorker.postMessage({
	            command: 'init',
	            config: {
	              sampleRate: 44100
	            }
	          ...
	          _this5.exportWorker.onmessage = function (e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BlobLoader = __webpack_require__(395);
	
	var _BlobLoader2 = _interopRequireDefault(_BlobLoader);
	
	var _XHRLoader = __webpack_require__(397);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Loader2 = __webpack_require__(396);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TimeScaleHook = __webpack_require__(400);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodash3 = __webpack_require__(402);
	...
	var _lodash5 = __webpack_require__(405);
	...
	var _CanvasHook = __webpack_require__(416);
	
	var _CanvasHook2 = _interopRequireDefault(_CanvasHook);
	
	var _FadeCanvasHook = __webpack_require__(417);
	
	var _FadeCanvasHook2 = _interopRequireDefault(_FadeCanvasHook);
	
	var _VolumeSliderHook = __webpack_require__(418);
	...
	var _class = function () {
	  function _class() {
	    ...
	    this.name = 'Untitled';
	    this.id = 'i' + _uuid2.default.v4(); // must start with a letter to be a valid css id
	  ...
	  _createClass(_class, [{
	    ...
	    */
	        ...
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 24:
	                peaks = (0, _lodash6.default)(this.peaks);
	    ...
	    key: 'duplicateTrack',
	    value: function () {
	      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(track, start, cueIn, cueOut, trackOffset) {
	        return regeneratorRuntime.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	    ...
	    */
	    ...
	    value: function renderControls(data) {
	      ...
	      }, [(0, _h2.default)('header', [this.taggedName]), (0, _h2.default)('div.btn-group', [(0, _h2.default)('span.btn.btn-default.i.fa.fa-volume-off', {
	        onclick: function onclick() {
	          _this2.ee.emit('mute', _this2);
	        }
	      }), (0, _h2.default)('span.btn.btn-default.i.fa.fa-crosshairs', {
	        onclick: function onclick() {
	          _this2.ee.emit('solo', _this2);
	        }
	      }), (0, _h2.default)('span.btn.btn-default.i.fa.fa-chevron-up', {
	        onclick: function onclick() {
	          _this2.ee.emit('moveUp', _this2);
	        }
	      }), (0, _h2.default)('span.btn.btn-default.i.fa.fa-chevron-down', {
	        onclick: function onclick() {
	          _this2.ee.emit('moveDown', _this2);
	        }
	      }), (0, _h2.default)('span.btn.btn-default.i.fa.fa-times', {
	        onclick: function onclick() {
	          _this2.ee.emit('delete', _this2);
	        }
	      }), (0, _h2.default)('span.btn.btn-default.i.fa.fa-files-o', {
	        onclick: function onclick() {
	          _this2.ee.emit('duplicate', _this2);
	        }
	      }), (0, _h2.default)('span.btn.btn-default.i.fa.fa-compress}', {
	        onclick: function onclick() {
	    ...
	    value: function render(data) {
	      ...
	      var channels = Object.keys(this.peaks.data).map(function (channelNum) {
	        ...
	        while (totalWidth > 0) {
	          ...
	          channelChildren.push((0, _h2.default)('canvas', {
	            ...
	            hook: new _CanvasHook2.default(peaks, offset, _this3.peaks.bits, canvasColor, _this3.scale, _this3.scale !== oldScale)
	          }));
	      ...
	      var full = (0, _h2.default)('div.channel-wrapper' + audibleClass + customClass, {
	        attributes: {
	      ...
	      var collapseButton = (0, _h2.default)('span.btn.btn-default.i.fa.fa-expand}', {
	        onclick: function onclick() {
	      ...
	      var collapse = (0, _h2.default)('div.controls', {
	        attributes: {
	          style: 'display: none; text-align: left;',
	          id: this.id + 'Header'
	        }
	      }, [(0, _h2.default)('header', [this.taggedName, collapseButton])]);
	
	      return (0, _h2.default)('', [collapse, full]);
	    }
	  }, {
	    key: 'getTrackDetails',
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(406)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _aeneas = __webpack_require__(421);
	
	var _aeneas2 = _interopRequireDefault(_aeneas);
	
	var _aeneas3 = __webpack_require__(422);
	
	var _aeneas4 = _interopRequireDefault(_aeneas3);
	
	var _conversions = __webpack_require__(393);
	
	var _DragInteraction = __webpack_require__(423);
	
	var _DragInteraction2 = _interopRequireDefault(_DragInteraction);
	
	var _ScrollTopHook = __webpack_require__(424);
