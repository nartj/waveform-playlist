          ...
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  track = _this2.tracks.find(function (t) {
                    return t.id === trackId;
                  });
                  _this2.tracks = _this2.tracks.filter(function (t) {
                    return t.id !== trackId;
                  });
                  _context.next = 4;
                  return _this2.load([{
    ...
    value: function load(trackList) {
      ...
      return Promise.all(loadPromises).then(function (audioBuffers) {
        ...
        var tracks = audioBuffers.map(function (audioBuffer, index) {
          ...
          var taggedName = info.taggedName;
          ...
          if (audioBuffer) track.calculatePeaks(_this3.samplesPerPixel, _this3.sampleRate);
          newTrack = track;
          return track;
        });
      ...
      */
      ...
      this.offlineAudioContext.startRendering().then(function (audioBuffer) {
        if (type === 'buffer') {
          ...
          _this4.oggExportWorker.onmessage = function (e) {
          ...
          _this4.oggExportWorker.postMessage({
            command: 'encodeOGG',
          ...
          _this4.wavExportWorker.postMessage({
            command: 'init',
            config: {
              sampleRate: 44100
            }
          ...
          _this4.wavExportWorker.onmessage = function (e) {
            _this4.ee.emit('audiorenderingfinished', type, e.data);

            _this4.isRendering = false; // clear out the buffer for next renderings.
...
var _default = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(_default, [{
    ...
    value: function setTaggedName() {
      var taggedName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
    ...
    */
    ...
    value: function renderOverlay(data) {
      ...
      var config = {
        attributes: {
          style: "position: absolute; top: 0; right: 0; bottom: 0; left: 0; width: ".concat(channelPixels, "px; z-index: 8;")
        }
      };
      var overlayClass = '';
    ...
    key: "renderFileInputOverlay",
    value: function renderFileInputOverlay(data) {
      var channelPixels = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_10__.secondsToPixels)(data.playlistLength, data.resolution, data.sampleRate);

      if (this.isUnloadedTrack) {
        var config = {
          attributes: {
            style: "position: relative; display:flex; align-items: center; \n          justify-content:center; height: 100%; width: ".concat(channelPixels, "px; \n          z-index: 9; background-color:rgba(220, 220, 220, 0.5);")
          }
        };
        return virtual_dom_h__WEBPACK_IMPORTED_MODULE_7___default()("div.playlist-overlay-input-file", config, [virtual_dom_h__WEBPACK_IMPORTED_MODULE_7___default()('label.btn.btn-info', {
          "for": 'reload-track'
        }, [virtual_dom_h__WEBPACK_IMPORTED_MODULE_7___default()("span", {
          title: 'Reload this track'
        }, ['Reload']), virtual_dom_h__WEBPACK_IMPORTED_MODULE_7___default()("input.btn-reload", {
          type: 'file',
          accept: 'audio/*',
          style: {
            display: 'none'
          },
          name: "".concat(this.taggedName),
          id: "".concat(this.id)
        })])]);
      }
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "automaticscroll": () => (/* binding */ automaticscroll),
/* harmony export */   "durationformat": () => (/* binding */ durationformat),
/* harmony export */   "select": () => (/* binding */ select),
/* harmony export */   "startaudiorendering": () => (/* binding */ startaudiorendering),
...
/* harmony export */   "volumechange": () => (/* binding */ volumechange),
/* harmony export */   "mastervolumechange": () => (/* binding */ mastervolumechange),
/* harmony export */   "fadein": () => (/* binding */ fadein),
/* harmony export */   "fadeout": () => (/* binding */ fadeout),
/* harmony export */   "fadetype": () => (/* binding */ fadetype),
/* harmony export */   "newtrack": () => (/* binding */ newtrack),
/* harmony export */   "duplicateTrack": () => (/* binding */ duplicateTrack),
